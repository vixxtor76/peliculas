...
<meta name="Description" content="Seccion de peliculas de comedia, donde podrás elegir y descargar tu preferida">
<meta name="Language" content="Spanish">
<link rel="stylesheet" href="./estilos/estilo_secciones.css" type="text/css">
</head>

<body>
<H3> Sección de Comedia </H3>
<?php
	...
	$consulta=mysqli_query($conexion,'select Codigo_identificador,Genero,Titulo,Cartel from peliculas where Genero="Comedia"');
